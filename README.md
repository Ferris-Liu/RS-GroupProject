...
| Member | Main Files |
|--------|------------|
| A (Frontend) | `templates/index.html`, `static/app.js` |
| B (Algorithm) | `recommender/collaborative.py`, `recommender/content_based.py` |
| C (Backend) | `flaskr/routes.py`, `recommender/engine.py`, `recommender/llm_helper.py` |
